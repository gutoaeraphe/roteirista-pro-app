      ...
      <div className="container mx-auto max-w-4xl">
        <Card>
          ...
          <CardContent className="prose prose-sm dark:prose-invert max-w-none text-muted-foreground space-y-4">
            ...
            <ul className="list-disc pl-5">
                <li>i. Com provedores de serviços estritamente necessários para a operação do Aplicativo (ex: serviços de hospedagem em nuvem), que estarão contratualmente obrigados a manter a confidencialidade e segurança dos dados.</li>
            ...
            <h2 className="text-xl font-semibold text-foreground">5. DIREITOS DOS TITULARES DOS DADOS</h2>
            ...
            <h2 className="text-xl font-semibold text-foreground">6. RETENÇÃO DOS DADOS</h2>
            ...
            <h2 className="text-xl font-semibold text-foreground">7. ATUALIZAÇÕES DESTA POLÍTICA DE PRIVACIDADE</h2>
