...
export default function LandingPage() {
  ...
  // <<-- FUTURAMENTE, ALTERE O LINK DO YOUTUBE AQUI -->>
  const youtubeVideoId = "dQw4w9WgXcQ"; // Exemplo: https://www.youtube.com/watch?v=dQw4w9WgXcQ -> use apenas "dQw4w9WgXcQ"
  ...
  return (
    <div className="bg-background text-foreground">
      ...
      {/* Video Section */}
      <section id="video-explicativo" className="py-20">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-headline mb-4">Veja Como Funciona</h2>
          <p className="text-lg text-muted-foreground mb-12 max-w-3xl mx-auto">
            Descubra em poucos minutos como o Roteirista Pro pode transformar a maneira como você desenvolve seus projetos.
          </p>
          <div className="aspect-video max-w-4xl mx-auto rounded-lg shadow-2xl overflow-hidden border">
             <iframe
                className="w-full h-full"
                src={`https://www.youtube.com/embed/${youtubeVideoId}?si=Vgrz1z8V9g2N34gS&showinfo=0&rel=0`}
